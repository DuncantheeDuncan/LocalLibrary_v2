...
// Book.findAll().then(function(value) {callback(null, value);},function(err){callback(err);});
  // async.parallel({
    ...
    (req, res, next) => {
      ...
      console.log('\n'+req.body.imprint+'\n');
        ...
        if (!errors.isEmpty()) {
            ...
            bookinstance.save().then(function(){
            // res.send("SAVED!!")  
...
// // Display BookInstance delete form on GET. // git
...
res.send('bookinstance_update_get')
